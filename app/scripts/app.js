...
angular
  .module('sampleAngularClientAppInternal', ['ngResource']);
...
angular
  .module('sampleAngularClientApp', ['sampleAngularClientAppInternal', 'sampleAngularClientTranslations', 'wixAngular'])
  .config(function () {
    return;
  });
